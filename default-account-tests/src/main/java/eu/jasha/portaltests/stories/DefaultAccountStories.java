 ...
 */
public class DefaultAccountStories extends JUnitStories {
    public DefaultAccountStories() {
        ...
        StoryReporterBuilder reporterBuilder = new StoryReporterBuilder()
                .withCodeLocation(codeLocationFromClass(DefaultAccountStories.class)).withFailureTrace(true)
        ...
        Configuration configuration = new SeleniumConfiguration().useSeleniumContext(seleniumContext)
                ...
                .useStoryLoader(new LoadFromClasspath(DefaultAccountStories.class))
                .useStoryReporterBuilder(reporterBuilder);
        useConfiguration(configuration);

        ApplicationContext context = new SpringApplicationContextFactory("default-account-steps.xml").createApplicationContext();
